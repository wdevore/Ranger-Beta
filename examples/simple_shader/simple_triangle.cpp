...
namespace Game
{
    ...
    void SimpleTriangle::fetchUniforms()
    {
        int err{0};
    ...
    GLint SimpleTriangle::fetchUniformVar(GLuint program, const std::string &name)
    {
    ...
    void SimpleTriangle::use()
    {
        ...
        glBindVertexArray(VAO);
        Core::checkGLError("SimpleTriangle::use:glBindVertexArray VAO");
    }
}