...
/*
Format, example "0"
Need: horizontal/vertical pixel offset
Each character is a shape with an ID.
RegExprs:
0x([A-Z0-9]+)      <-- the entire hex number
